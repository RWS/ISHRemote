...
<!ENTITY % ish-topicsubject-atts
              "%ish-topicref-atts;">
<!ENTITY % ish-topicapply-atts
              "%ish-topicref-atts;">
<!ENTITY % ish-subjectref-atts
              "%ish-topicref-atts;">

<!ENTITY % ish-topicSubjectTable-atts           
           "ishtype      CDATA #FIXED 'ISHSection'
            ishlabelxpath CDATA   #FIXED   'concat(string(&apos;Subject Table &apos;), @title)'            
            %ishlinkxpath-general-default;"
>
            
<!ENTITY % ish-topicSubjectHeader-atts             
           "ishtype      CDATA #FIXED 'ISHSection'
            ishlabelxpath CDATA   #FIXED   'string(&apos;Subject Column Specification&apos;)'
            %ishlinkxpath-general-default;"
>
            
<!ENTITY % ish-topicSubjectRow-atts                  
           "ishtype      CDATA #FIXED 'ISHSection'
            ishlabelxpath CDATA   #FIXED   'string(&apos;Relation&apos;)'
            %ishlinkxpath-general-default;"
>
              
<!ENTITY % ish-topicCell-atts                      
						"ishtype      CDATA #FIXED 'ISHSection'
             ishlabelxpath CDATA   #FIXED  'concat(string(&apos;Topic &apos;), @type | @linking)'
             %ishlinkxpath-section-default;"
>

<!ENTITY % ish-subjectCell-atts                                       
						"ishtype      CDATA #FIXED 'ISHSection'
             ishlabelxpath CDATA   #FIXED  'concat(string(&apos;Subject &apos;), @type | @linking)'
             %ishlinkxpath-section-default;"
>
...
<!-- ====================================================== -->
<!--             INFOSHARE CONTENT SET OVERRULES            -->
<!-- ====================================================== -->

<!-- Use ish.subjectCell.content instead of subjectCell.content later in this file to avoid "Non deterministic content model" error in XMetaL -->
<!ENTITY % ish-subjectCell-content
                       "((%data.elements.incl; |
                          %subjectref; |
                          %topicapply; |
                          %topicref;)*)"
...
<!ENTITY % subjectCell.attributes
             "%univ-atts;
              %topicref-atts;
              %ish-subjectCell-atts;"
>
<!-- Use ish-subjectCell-content instead of subjectCell.content to avoid "Non deterministic content model" error in XMetaL -->
<!-- ELEMENT subjectCell    %subjectCell.content; -->
<!ELEMENT subjectCell    %ish-subjectCell-content;>
