...
<!ENTITY % ish-learningref-atts
          "ishtype      CDATA #FIXED 'ISHSection'                                   
           %ishlinkxpath-section-default;">
           
<!ENTITY % ish-learningDomain-topicref-atts-no-chunk
              "%ish-learningref-atts;">
              ...
              search
                        (yes|
                         ...
                         -dita-use-conref-target)
                                   #IMPLIED
              %univ-atts;
              %ish-learningDomain-topicref-atts-no-chunk;"
>
...
<!ENTITY % learningGroup.attributes
             "%learningDomain-topicref-atts;
              ishlabelxpath CDATA   #FIXED   'substring( concat(./topicmeta/navtitle, string(&apos; (Learning Group)&apos;))  , number(@href!=&apos;&apos;)*10000)'
              collection-type
                        (choice|
                         unordered|
                         sequence|
...
<!ENTITY % learningObject.attributes
             "%learningDomain-topicref-atts;
              ishlabelxpath CDATA   #FIXED   'substring( concat(./topicmeta/navtitle, string(&apos; (Learning Object)&apos;))  , number(@href!=&apos;&apos;)*10000)'
              collection-type
                        (choice|
                         unordered|
                         sequence|
...
<!ENTITY % learningPlanRef.attributes
             "%learningObjectComponent-topicref-atts;
              ishlabelxpath CDATA   #FIXED   'substring( concat(./topicmeta/navtitle, string(&apos; (Learning Plan)&apos;))  , number(@href!=&apos;&apos;)*10000)'
              type
                        CDATA
                                  'learningPlan'
              format
...
<!ENTITY % learningOverviewRef.attributes
             "%learningObjectComponent-topicref-atts;
              ishlabelxpath CDATA   #FIXED   'substring( concat(./topicmeta/navtitle, string(&apos; (Learning Overview)&apos;))  , number(@href!=&apos;&apos;)*10000)'
              type
                        CDATA
                                  'learningOverview'
              format
...
<!ENTITY % learningSummaryRef.attributes
             "%learningObjectComponent-topicref-atts;
              ishlabelxpath CDATA   #FIXED   'substring( concat(./topicmeta/navtitle, string(&apos; (Learning Summary)&apos;))  , number(@href!=&apos;&apos;)*10000)'
              type
                        CDATA
                                  'learningSummary'
              format
...
<!ENTITY % learningContentRef.attributes
             "%learningDomain-topicref-atts-no-chunk;
              ishlabelxpath CDATA   #FIXED   'substring( concat(./topicmeta/navtitle, string(&apos; (Learning Content)&apos;))  , number(@href!=&apos;&apos;)*10000)'
              type
                        CDATA
                                  #IMPLIED
              format
...
<!ENTITY % learningContentComponentRef.attributes
             "%learningDomain-topicref-atts;
              ishlabelxpath CDATA   #FIXED   'substring( concat(./topicmeta/navtitle, string(&apos; (Learning Content Component)&apos;))  , number(@href!=&apos;&apos;)*10000)'
              type
                        CDATA
                                  #IMPLIED
              format
...
<!ENTITY % learningPreAssessmentRef.attributes
             "%learningObjectComponent-topicref-atts;
              ishlabelxpath CDATA   #FIXED   'substring( concat(./topicmeta/navtitle, string(&apos; (Learning Pre Assessment)&apos;))  , number(@href!=&apos;&apos;)*10000)'
              type
                        CDATA
                                  'learningAssessment'
              format
...
<!ENTITY % learningPostAssessmentRef.attributes
             "%learningObjectComponent-topicref-atts;
              ishlabelxpath CDATA   #FIXED   'substring( concat(./topicmeta/navtitle, string(&apos; (Learning Post Assessment)&apos;))  , number(@href!=&apos;&apos;)*10000)'
              type
                        CDATA
                                  'learningAssessment'
              format
