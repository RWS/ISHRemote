    ...
    public sealed class FindIshUser : UserCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                var activityFilter = EnumConverter.ToActivityFilter<User25ServiceReference.eActivityFilter>(ActivityFilter);
                ...
                var response = IshSession.User25.Find(new User25ServiceReference.FindRequest()
                {
