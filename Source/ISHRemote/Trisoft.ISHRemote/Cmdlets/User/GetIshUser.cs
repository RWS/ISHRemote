            ...
            {                
                ...
                else
                {
                    ...
                    if (Id == null && IshObject == null)
                    {
                        ...
                        xmlIshObjects = IshSession.User25.GetMyMetadata(requestedMetadata.ToXml());
                    }
                    else
                    {
                        User25ServiceReference.ActivityFilter activityFilter =
                            EnumConverter.ToActivityFilter<User25ServiceReference.ActivityFilter>(ActivityFilter);
                        ...
                        xmlIshObjects = IshSession.User25.RetrieveMetadata(
                            ids,
                            activityFilter,
