                        ...
                        if (documentLogicalIds.Any())
                        {
                            ...
                            foreach (List<string> logicalIdBatch in devidedDocumentLogicalIdsList)
                            {
                                ...
                                if (VersionFilter != null && VersionFilter.Length > 0)
                                {
                                    ...
                                    xmlIshObjects = "";
                                    var responseRetrieveVersion = IshSession.DocumentObj25.RetrieveVersionMetadata(new DocumentObj25ServiceReference.RetrieveVersionMetadataRequest()
                                    {
                                        psAuthContext = IshSession.AuthenticationContext,
                                    ...
                                    if (documentIshObjects.Objects.Length > 0)
                                    {
                                        ...
                                        var versionRefs = documentIshObjects.Objects
                                            ...
                                            .ToList();
                                        xmlIshObjects = "";
                                        var responseRetrieve = IshSession.DocumentObj25.RetrieveMetadataByIshVersionRefs(new DocumentObj25ServiceReference.RetrieveMetadataByIshVersionRefsRequest()
                                        {
                                            psAuthContext = IshSession.AuthenticationContext,
                                ...
                                else
                                {
                                    ...
                                    xmlIshObjects = "";
                                    var response = IshSession.DocumentObj25.RetrieveMetadata(new DocumentObj25ServiceReference.RetrieveMetadataRequest()
                                    {
                                        psAuthContext = IshSession.AuthenticationContext,
                                        pasLogicalIds = logicalIdBatch.ToArray(),
                                        peStatusFilter = DocumentObj25ServiceReference.eISHStatusgroup.ISHNoStatusFilter,
                        ...
                        if (publicationLogicalIds.Any())
                        {
                            ...
                            foreach (List<string> logicalIdBatch in devidedPublicationLogicalIdsList)
                            {
                                ...
                                if (VersionFilter != null && VersionFilter.Length > 0)
                                {
                                    ...
                                    xmlIshObjects = "";
                                    var response = IshSession.PublicationOutput25.RetrieveVersionMetadata(new PublicationOutput25ServiceReference.RetrieveVersionMetadataRequest()
                                    { 
                                        psAuthContext = IshSession.AuthenticationContext,
                                        pasLogicalIds = logicalIdBatch.ToArray(),
                                        psVersion = VersionFilter,
                                    ...
                                    if (publicationIshObjects.Objects.Length > 0)
                                    {
                                        ...
                                        var versionRefs = publicationIshObjects.Objects
                                            ...
                                            .ToList();
                                        xmlIshObjects = "";
                                        var responseRetrieve = IshSession.PublicationOutput25.RetrieveMetadataByIshVersionRefs(new PublicationOutput25ServiceReference.RetrieveMetadataByIshVersionRefsRequest()
                                        { 
                                            psAuthContext = IshSession.AuthenticationContext,
                                            palVersionRefs = versionRefs.ToArray(),
                                ...
                                else
                                {
                                    ...
                                    xmlIshObjects = "";
                                    var responseRetrieve = IshSession.PublicationOutput25.RetrieveMetadata(new PublicationOutput25ServiceReference.RetrieveMetadataRequest()
                                    {
                                        psAuthContext = IshSession.AuthenticationContext,
                                        pasLogicalIds = logicalIdBatch.ToArray(),
                                        peStatusFilter = PublicationOutput25ServiceReference.eISHStatusgroup.ISHNoStatusFilter,
