                ...
                else
                {
                    if (IshFolders != null)
                    {
                        ...
                        foreach (IshFolder ishFolder in ishFolders)
                        {
                            ...
                            {
                                var responseMove = IshSession.Folder25.Move(new Folder25ServiceReference.MoveRequest()
                                {
                                    psAuthContext = IshSession.AuthenticationContext,
                                    plFolderRef = folderId,
                                    plToFolderRef = toFolderId
                                });
                                IshSession.AuthenticationContext = responseMove.psAuthContext;
