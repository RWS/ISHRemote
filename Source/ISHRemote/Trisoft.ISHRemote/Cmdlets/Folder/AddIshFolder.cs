                ...
                else
                {
                    ...
                    if (IshFolder != null)
                    {
                        ...
                        foreach (IshFolder ishFolder in IshFolder)
                        {
                            ...
                            string[] readAccess = readAccessString.Split(new string[] { IshSession.Seperator }, StringSplitOptions.None);
                    ...
                    string xmlIshFolders = IshSession.Folder25.RetrieveMetadataByIshFolderRefs(
                        foldersToRetrieve.ToArray(),
