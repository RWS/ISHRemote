...
Describe "Get-IshFolder" -Tags "Read" {
	...
	Context "Get-IshFolder FolderPathGroup" {
		It "Parameter FolderPath invalid" {
			$exception = { Get-IshFolder -IShSession $ishSession -FolderPath "INVALIDFOLDERPATH" } | Should-Throw
	...
	Context "Get-IshFolder EditorTemplate Recurse" {
		...
		It "GetType()" {
			$ishFolderEditorTemplateRecursive[0].GetType().Name | Should-BeString -CaseSensitive "IshFolder"
		}
	...
	Context "Get-IshFolder Recurse Sort and Traversal" {
		...
		It "Get-IshFolder ishFolderCmdlet Traversal 'All'" {
			Get-IshMetadataField -IshSession $ishSession -Name "FNAME" -Level None -IshField((Get-IshFolder -IShSession $ishSession -IshFolder $ishFolderCmdlet -Recurse)[1].IshField) | Should-MatchString -CaseSensitive "All"
		}
		It "Get-IshFolder ishFolderCmdlet Traversal 'aLL'" {
			Get-IshMetadataField -IshSession $ishSession -Name "FNAME" -Level None -IshField((Get-IshFolder -IShSession $ishSession -IshFolder $ishFolderCmdlet -Recurse)[7].IshField) | Should-MatchString -CaseSensitive "aLL yOUR bASE bELONG tO uS!"
		}
		It "Get-IshFolder ishFolderCmdlet Traversal 'All' with FolderTypeFilter" {
			Get-IshMetadataField -IshSession $ishSession -Name "FNAME" -Level None -IshField((Get-IshFolder -IShSession $ishSession -IshFolder $ishFolderCmdlet -FolderTypeFilter @("ISHModule", "ISHNone") -Recurse)[1].IshField) | Should-MatchString -CaseSensitive "All"
		}
		It "Get-IshFolder ishFolderCmdlet Traversal 'aLL' with FolderTypeFilter" {
			Get-IshMetadataField -IshSession $ishSession -Name "FNAME" -Level None -IshField((Get-IshFolder -IShSession $ishSession -IshFolder $ishFolderCmdlet -FolderTypeFilter @("ISHModule", "ISHNone") -Recurse)[7].IshField) | Should-MatchString -CaseSensitive "aLL yOUR bASE bELONG tO uS!"
		}
	}
