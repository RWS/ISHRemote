        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                foreach (long returnFolderId in returnFolderIds)
                {
                    ...
                    var response = IshSession.Folder25.FolderLocation(new Folder25ServiceReference.FolderLocationRequest()
                    { 
                        psAuthContext = IshSession.AuthenticationContext,
                    ...
                    var folderPaths = new List<string>() { BaseFolderEnumToLabel(IshSession, response.peOutBaseFolder) };
                    folderPaths.AddRange(response.pasOutFolderPath);
