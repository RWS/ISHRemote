        ...
        internal override IshFields RemoveSystemFields(IshFields ishFields, Enumerations.ActionMode actionMode)
        {
            ...
            { 
                if (actionMode == Enumerations.ActionMode.Create)
                {
                    ...
                    ishFields.RemoveField(FieldElements.UserRoleName, level, valueType);
                    ishFields.RemoveField(FieldElements.Name, level, valueType);

                    // When creating the user role, the user role is always active..so, the value cannot be set
                ...
                {
                    ishFields.RemoveField(FieldElements.UserRoleName, level, Enumerations.ValueType.Id);
                    ishFields.RemoveField(FieldElements.UserRoleName, level, Enumerations.ValueType.Element);
                }
