...
namespace Trisoft.ISHRemote.Cmdlets.EDT
{
    public abstract class EDTCmdlet : TrisoftCmdlet
    {
        ...
        public virtual IshFields AddRequiredFields(IshFields currentFields)
        {
            ...
            currentFields.AddOrUpdateField(new IshRequestedMetadataField("EDT-CANDIDATE", Enumerations.Level.None, Enumerations.ValueType.Value));
            currentFields.AddOrUpdateField(new IshRequestedMetadataField("FISHOBJECTACTIVE", Enumerations.Level.None, Enumerations.ValueType.Value));
            currentFields.AddOrUpdateField(new IshRequestedMetadataField("FISHEDTNAME", Enumerations.Level.None, Enumerations.ValueType.Value));
        ...
        internal override IshFields RemoveSystemFields(IshFields ishFields, Enumerations.ActionMode actionMode)
        {
            ...
            if (actionMode == Enumerations.ActionMode.Create)
            {
                ...
                // When creating the EDT, the object is always active..so, the value cannot be set
            ...
            {
                ishFields.RemoveField(FieldElements.EDTName, level, Enumerations.ValueType.Id);
                ishFields.RemoveField(FieldElements.EDTName, level, Enumerations.ValueType.Element);
            }
