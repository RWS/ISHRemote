...
Describe “Remove-IshAnnotation" -Tags "Create" {
	...
	$ishAnnotationPG1 = Add-IshAnnotation -IshSession $ishsession -PubLogicalId $ishObjectPub.IshRef -PubVersion $ishObjectPub.version_version_value -LogicalId $ishObjectTopic.IshRef -Version $ishObjectTopic.version_version_value -Lng $ishObjectTopic.doclanguage -Type $annotationType -Text $annotationText -Status $annotationStatus -Category $annotationCategory -Address $annotationAddress
	...
	Context "Remove-IshAnnotation ParametersGroup" {
		...
		#ToDo: Add test which checks annotation was really deleted
    }
    ...
    #ToDo: improve cleanup below with deleting annotations
}
