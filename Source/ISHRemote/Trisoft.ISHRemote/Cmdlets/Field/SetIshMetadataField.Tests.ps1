...
Describe "Set-IshMetadataField" -Tags "Read" {
	...
	Context "Set-IshMetadataField returns IshMetadataField" {
		It "GetType().Name" {
			(Set-IshMetadataField -IshSession $ishSession -Name "FTITLE").GetType().Name | Should-BeString -CaseSensitive "IshMetadataField"
		}
	...
	Context "Set-IshMetadataField returns IshFolder" {
		It "GetType().Name" {
			(Set-IshMetadataField -IshSession $ishSession -Name "FNAME" -IshFolder $ishFolderDataOriginal).GetType().Name | Should-BeString -CaseSensitive "IshFolder"
		}
		It "Parameter Name Level ValueType Value" {
			$value = "MYSTRING"
