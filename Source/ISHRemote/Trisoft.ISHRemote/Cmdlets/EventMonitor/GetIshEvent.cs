...
namespace Trisoft.ISHRemote.Cmdlets.EventMonitor
{
    ...
    public sealed class GetIshEvent : EventCmdlet
    {
        ...
        public Enumerations.ProgressStatusFilter ProgressStatusFilter
        {
            ...
            set { _progressStatusFilter = EnumConverter.ToProgressStatusFilter<EventMonitor25ServiceReference.eProgressStatusFilter>(value); }
        }
        ...
        public Enumerations.UserFilter UserFilter
        {
            ...
            set { _userFilter = EnumConverter.ToUserFilter<EventMonitor25ServiceReference.eUserFilter>(value); }
        }
        ...
        public Enumerations.EventLevel EventLevel
        {
            ...
            set { _eventLevel = EnumConverter.ToEventLevelFilter<EventMonitor25ServiceReference.eEventLevel>(value); }
        }
        ...
        private EventMonitor25ServiceReference.eProgressStatusFilter _progressStatusFilter = EventMonitor25ServiceReference.eProgressStatusFilter.All;
        private EventMonitor25ServiceReference.eUserFilter _userFilter = EventMonitor25ServiceReference.eUserFilter.All;
        private EventMonitor25ServiceReference.eEventLevel _eventLevel = EventMonitor25ServiceReference.eEventLevel.Information;
        ...
        protected override void EndProcessing()
        {
            try
            {
                ...
                if (_retrievedIshEvents.Count == 0)
                {
                    ...
                    var response = IshSession.EventMonitor25.RetrieveEventOverview(new EventMonitor25ServiceReference.RetrieveEventOverviewRequest()
                    {
                        psAuthContext = IshSession.AuthenticationContext,
                        pasEventTypes = EventTypes,
                        peStatusFilter = _progressStatusFilter,
                        pdModifiedSince = ModifiedSince,
                        peUserFilter = _userFilter,
                        psXMLRequestedEventData = progressLevelRequestedMetadata.ToXml()
                    });
                    IshSession.AuthenticationContext = response.psAuthContext;
                    xmlIshEvents = response.psOutXMLEventList;
                ...
                if (progressRefs.Count != 0)
                {
                    ...
                    var response = IshSession.EventMonitor25.RetrieveEventsByProgressIds(new EventMonitor25ServiceReference.RetrieveEventsByProgressIdsRequest()
                    {
                        psAuthContext = IshSession.AuthenticationContext,
                        palProgressIds = progressRefs.ToArray(),
                        peLevelFilter = _eventLevel,
                        plLastDetailId = lastDetailId,
                        psXMLEventDataFilter = metadataFilter.ToXml(),
                        psXMLRequestedEventData = requestedMetadata.ToXml()
                    });
                    IshSession.AuthenticationContext = response.psAuthContext;
                    xmlIshEvents = response.psOutXMLEventList;
                    _retrievedIshEvents = new IshEvents(xmlIshEvents).Events;
